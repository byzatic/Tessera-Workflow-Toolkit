package io.github.byzatic.tessera.service.configuration;
...
public class ServiceConfigurationParameter {
    ...
    private ServiceConfigurationParameter(Builder builder) {
    ...
    public static Builder newBuilder(ServiceConfigurationParameter copy) {
    ...
    public boolean equals(Object o) {
        ...
        ServiceConfigurationParameter that = (ServiceConfigurationParameter) o;
    ...
    public static final class Builder {
         ...
         */
        public ServiceConfigurationParameter build() {
            return new ServiceConfigurationParameter(this);
        }
    }
}
